...
with_node \
  ...
  --target "/Users/usuario/BUENOS_PANES/panaderia-frontend/ios/Pods/Target Support Files/Pods-panaderiafrontend/ExpoModulesProvider.swift" \
  --entitlement "/Users/usuario/BUENOS_PANES/panaderia-frontend/ios/panaderiafrontend/panaderiafrontend.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
